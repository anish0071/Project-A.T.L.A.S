...
st.set_page_config(
    page_title="Project: A.T.L.A.S.",
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={"About": "Algorithm Trading Learning Analysis System"}
)
